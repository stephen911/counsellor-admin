...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-chartjs-other.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:51 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Chartjs | GNACC -  </title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="bubble-example" data-colors="#727cf5,#10c469"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="donut-example" data-colors="#727cf5,#ff5b5b,#10c469,#ebeff2"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="pie-example" data-colors="#727cf5,#ff5b5b,#10c469,#ebeff2, #f56f36"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="polar-area-example" data-colors="#727cf5,#ff5b5b,#10c469,#ebeff2, #f56f36"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="radar-example" data-colors="#727cf5,#10c469"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="scatter-example" data-colors="#727cf5,#10c469"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="bar-line-example" data-colors="#727cf5,#10c469"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-chartjs-other.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:52 GMT -->
</html>
