...
<!-- Mirrored from coderthemes.com/hyper_2/modern/apps-projects-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:18:54 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Projects | GNACC -  </title>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="apps-projects-add.php" class="btn btn-danger rounded-pill mb-3"><i class="mdi mdi-plus"></i> Create Project</a>
                            </div>
                            <div class="col-sm-8">
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <div class="card-body">
                                        ...
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.php" class="text-title">App design and development</a>
                                        </h4>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <div class="card-body">
                                        ...
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.php" class="text-title">Coffee detail page - Main Page</a>
                                        </h4>
                                        <div class="badge bg-secondary text-light">Ongoing</div>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <div class="card-body">
                                        ...
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.php" class="text-title">Poster illustation design</a>
                                        </h4>
                                        <div class="badge bg-secondary text-light">Ongoing</div>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <div class="card-body">
                                        ...
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.php" class="text-title">Drinking bottle graphics </a>
                                        </h4>
                                        <div class="badge bg-success">Finished</div>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.php" class="text-title">Company logo design</a>
                                        </h4>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.php" class="text-title">Landing page design - Home</a>
                                        </h4>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.php" class="text-title">Product page redesign</a>
                                        </h4>
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/apps-projects-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:18:56 GMT -->
</html>
