...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-apex-bar.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:36 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Apex Bar Charts | GNACC -  </title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="grouped-bar" class="apex-charts" data-colors="#ff5b5b,#6c757d"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="stacked-bar" class="apex-charts" data-colors="#727cf5,#10c469,#ff5b5b,#6c757d,#39afd1"></div>    
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="negative-bar" class="apex-charts" data-colors="#ff5b5b,#10c469"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="reversed-bar" class="apex-charts" data-colors="#727cf5,#10c469"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="image-fill-bar" class="apex-charts" data-colors="#727cf5,#10c469,#e3eaef"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="datalables-bar" class="apex-charts" data-colors="#727cf5,#10c469,#ff5b5b,#6c757d,#39afd1,#2b908f,#ffbc00,#90ee7e,#f48024,#212730"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="pattern-bar" class="apex-charts" data-colors="#727cf5,#10c469,#ff5b5b,#39afd1"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="bar-markers" class="apex-charts" data-colors="#10c469,#ff5b5b"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-apex-bar.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:37 GMT -->
</html>
