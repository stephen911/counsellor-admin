...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-apex-pie.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:46 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Apex Pie Charts | GNACC -  </title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="simple-pie" class="apex-charts" data-colors="#727cf5,#6c757d,#10c469,#ff5b5b,#e3eaef"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="simple-donut" class="apex-charts" data-colors="#39afd1,#ffbc00,#313a46,#ff5b5b,#10c469"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="gradient-donut" class="apex-charts" data-colors="#727cf5,#6c757d,#10c469,#ff5b5b,#e3eaef"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="patterned-donut" class="apex-charts" data-colors="#39afd1,#ffbc00,#313a46,#ff5b5b,#10c469"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="image-pie" class="apex-charts" data-colors="#39afd1,#ffbc00,#727cf5,#10c469"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="update-donut" class="apex-charts" data-colors="#727cf5,#6c757d,#10c469,#ff5b5b"></div>
                                        </div>
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-apex-pie.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:47 GMT -->
</html>
