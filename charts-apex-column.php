...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-apex-column.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:40 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Apex Column Charts | GNACC -  </title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="basic-column" class="apex-charts" data-colors="#727cf5,#10c469,#ff5b5b"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="full-stacked-column" class="apex-charts" data-colors="#39afd1,#10c469,#e3eaef"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="column-with-group-label" class="apex-charts" data-colors="#39afd1,#10c469,#e3eaef"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="rotate-labels-column" class="apex-charts" data-colors="#ff5b5b"></div>    
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="distributed-column" class="apex-charts" data-colors="#727cf5,#6c757d,#10c469,#ff5b5b,#ffbc00,#39afd1,#e3eaef,#313a46"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div dir="ltr">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div id="chart-year" data-colors="#727cf5,#6c757d,#10c469,#ff5b5b,#ffbc00,#39afd1"></div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div id="chart-quarter" data-colors="#727cf5,#6c757d,#10c469,#ff5b5b,#ffbc00,#39afd1"></div>
                                                </div>
                                            </div> <!-- end row-->
                                        </div>
                                    </div>
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-apex-column.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:42 GMT -->
</html>
