...
<!-- Mirrored from coderthemes.com/hyper_2/modern/ui-offcanvas.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:26 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Offcanvas | GNACC -  </title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-13">Change the appearance of offcanvases with utilities to better match them to different contexts like dark navbars.
                                            ...
                                            <code>.dropdown-menu-dark</code> to <code>.dropdown-menu</code>.</p>

                                        <ul class="nav nav-tabs nav-bordered mb-3">
                                            <li class="nav-item">
                                                <a href="#offcanvas-dark-preview" data-bs-toggle="tab"
                                                    aria-expanded="false" class="nav-link active">
                                                    Preview
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#offcanvas-dark-code" data-bs-toggle="tab" aria-expanded="true"
                                                    class="nav-link">
                                                    Code
                                                </a>
                                            </li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="offcanvas-dark-code">
                                                <pre class="mb-0">
                                                    <span class="html escape">
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/ui-offcanvas.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:27 GMT -->
</html>
