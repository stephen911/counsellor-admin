...
<!-- Mirrored from coderthemes.com/hyper_2/modern/ui-notifications.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:25 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Notifications | GNACC -  </title>
                                                        ...
                                                        <div class="p-3">
                                                            ...
                                                            <div class="toast fade show" role="alert" aria-live="assertive"
                                                                ...
                                                                <div class="toast-header">
                                                                    <img src="assets/images/logo-dark-sm.png"
                                                                        alt="brand-logo" height="16" class="me-1" />
                                                                    <strong class="me-auto">GNACC</strong>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-bordered mb-3">
                                            ...
                                            <li class="nav-item">
                                                <a href="#custom-toast-code" data-bs-toggle="tab" aria-expanded="true"
                                                    class="nav-link">
                                                    Code
                                                </a>
                                            </li>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="custom-toast-preview">
                                                <div class="toast show align-items-center mb-4" role="alert"
                                                    aria-live="assertive" aria-atomic="true">
                                                    <div class="d-flex">
                                                        <div class="toast-body">
                                                            Hello, world! This is a toast message.
                                                ...
                                                <div class="toast show mb-4" role="alert" aria-live="assertive"
                                                    aria-atomic="true">
                                                    <div class="toast-body">
                                                        Hello, world! This is a toast message.
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-bordered mb-3">
                                            <li class="nav-item">
                                                <a href="#placement-toast-preview" data-bs-toggle="tab"
                                                    aria-expanded="false" class="nav-link active">
                                                    Preview
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#placement-toast-code" data-bs-toggle="tab" aria-expanded="true"
                                                    class="nav-link">
                                                    Code
                                                </a>
                                            </li>
                                                ...
                                                <div aria-live="polite" aria-atomic="true"
                                                    ...
                                                    <div class="toast-container position-absolute p-3" id="toastPlacement">
                                                        <div class="toast show">
                                                            <div class="toast-header">
                                                                <img src="assets/images/logo-dark-sm.png" alt="brand-logo"
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/ui-notifications.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:26 GMT -->
</html>