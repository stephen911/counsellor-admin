...
<!-- Mirrored from coderthemes.com/hyper_2/modern/landing.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:11 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Landing Page | GNACC -  </title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg py-lg-3 navbar-dark">
            <div class="container">
                ...
                <!-- logo -->
                <a href="index-2.php" class="navbar-brand me-lg-5">
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="mt-md-4">
                            ...
                            <p class="mb-4 font-16 text-white-50">GNACC is a fully featured dashboard and admin template
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            <p class="text-muted mt-2">GNACC comes with next generation ui design and have multiple benefits
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row mt-2 py-5 align-items-center">
                    ...
                    <div class="col-lg-6 offset-md-1 col-md-5">
                        ...
                        <p class="text-muted mt-3">GNACC comes with a variety of ready-to-use applications and pages that help to speed up the development</p>
                ...
                <div class="row pb-3 pt-5 align-items-center">
                    <div class="col-lg-6 col-md-5">
                        ...
                        <p class="text-muted mt-3">The simplest and fastest way to build dashboard or admin panel. GNACC is built using the latest tech and tools and provide an easy way to customize anything, including an overall color schemes, layout, etc.</p>
            ...
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div>
                            <div class="faq-question-q-box">Q.</div>
                            <h4 class="faq-question text-body">Will you regularly give updates of GNACC?</h4>
                            <p class="faq-answer mb-4 pb-1 text-muted">Yes, We will update the GNACC regularly. All the
        ...
        <footer class="bg-dark py-5">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <img src="assets/images/logo.png" alt="logo" class="logo-dark" height="22" />
                        <p class="text-muted mt-4">GNACC makes it easier to build better websites with
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mt-5">
                            <p class="text-muted mt-4 text-center mb-0">© 2018 - <script>document.write(new Date().getFullYear())</script> GNACC. Design and coded by
                                Coderthemes</p>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/landing.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:21 GMT -->
</html>