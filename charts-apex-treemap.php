...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-apex-treemap.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:46 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Apex Treemap Charts | GNACC -  </title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="multiple-treemap" class="apex-charts" data-colors="#ff5b5b,#6c757d"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="distributed-treemap" class="apex-charts" data-colors="#727cf5,#10c469,#ff5b5b,#6c757d,#39afd1,#f9c851, #eef2f7, #313a46"></div>    
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
