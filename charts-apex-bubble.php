...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-apex-bubble.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:37 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Apex Bubble Charts | GNACC -  </title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="simple-bubble" class="apex-charts" data-colors="#727cf5,#ffbc00,#ff5b5b"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="second-bubble" class="apex-charts" data-colors="#727cf5,#10c469,#ff5b5b,#39afd1"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
