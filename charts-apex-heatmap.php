...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-apex-heatmap.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:42 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Apex Heatmap Charts | GNACC -  </title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="color-range-heatmap" class="apex-charts" data-colors="#ff5b5b,#ffbc00,#39afd1,#10c469"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="rounded-heatmap" class="apex-charts" data-colors="#10c469,#ffbc00"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
