...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-chartjs-bar.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:50 GMT -->
<head>
        <meta charset="utf-8" />
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="border-radius-example" data-colors="#727cf5,#10c469"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="floating-example" data-colors="#727cf5,#10c469"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="horizontal-example" data-colors="#727cf5,#10c469"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="stacked-example" data-colors="#727cf5,#10c469"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="group-stack-example" data-colors="#727cf5,#10c469"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div class="mt-3 chartjs-chart" style="height: 320px;">
                                                <canvas id="vertical-example" data-colors="#727cf5,#10c469"></canvas>
                                            </div>
                                        </div>
                                    </div> <!-- end card body-->
                                </div> <!-- end card -->
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-chartjs-bar.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:51 GMT -->
</html>
