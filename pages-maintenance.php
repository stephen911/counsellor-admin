...
<!-- Mirrored from coderthemes.com/hyper_2/modern/pages-maintenance.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:09 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Maintenance | GNACC -  </title>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-4">
                                    <div class="text-center mt-3 ps-1 pe-1">
                                        <i class="ri-vip-diamond-line bg-primary maintenance-icon text-white mb-2"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="text-center mt-3 ps-1 pe-1">
                                        <i class="ri-time-line bg-primary maintenance-icon text-white mb-2"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="text-center mt-3 ps-1 pe-1">
                                        <i class="ri-question-mark bg-primary maintenance-icon text-white mb-2"></i>
