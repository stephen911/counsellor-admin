...
<!-- Mirrored from coderthemes.com/hyper_2/modern/apps-social-feed.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:18:59 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Social Feed | GNACC -  </title>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-self-start">
                                            <img class="d-flex align-self-start rounded me-2" src="assets/images/users/avatar-5.jpg" alt="Dominic Keller" height="48">
                            ...
                            <div class="col-xxl-6 col-lg-12 order-lg-2 order-xxl-1">
                                ...
                                <div class="card">
                                    <div class="card-body pb-1">
                                        <div class="d-flex">
                                            <img class="me-2 rounded" src="assets/images/users/avatar-5.jpg" alt="Generic placeholder image" height="32">
                                            <div class="w-100">
                                                <div class="dropdown float-end text-muted">
                                                    <a href="#" class="dropdown-toggle arrow-none card-drop"
                                                        data-bs-toggle="dropdown" aria-expanded="false">
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/apps-social-feed.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:02 GMT -->
</html>
