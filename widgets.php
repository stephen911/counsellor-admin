...
<head>
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="card">
                                    <div class="card-body p-0" dir="ltr">
                                        <div id="profit-spark" class="apex-charts" data-colors="#10c469"></div>
                                    </div> <!-- end card-body-->
                                </div> <!-- end card-->
                            </div> <!-- end col -->
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card widget-flat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="float-end">
                                            <i class="mdi mdi-currency-usd widget-icon bg-success-lighten text-success bg-light-lighten rounded-circle text-white"></i>
                                        </div>
                                ...
                                <div class="card cta-box bg-primary text-white">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <img class="my-3" src="assets/images/svg/report.svg" width="180" alt="Generic placeholder image">
        ...
        <!-- Chat js -->
        <script src="../assets/js/ui/component.chat.php"></script>
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/widgets.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:34 GMT -->
</html>
