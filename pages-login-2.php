                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <form action="#">
                            ...
                            <div class="mb-3">
                                <a href="pages-recoverpw-2.php" class="text-muted float-end"><small>Forgot your password?</small></a>
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">Don't have an account? <a href="pages-register-2.php" class="text-muted ms-1"><b>Sign Up</b></a></p>
                        </footer>
