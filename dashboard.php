...
<head>
    <meta charset="utf-8" />
    <title>Dashboard | GNACC - Dashboard</title>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <div class="avatar-lg">
                                                        <img src="assets/images/logo.png" alt="" class="rounded-circle img-thumbnail">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div>
                                                        <h4 class="mt-1 mb-1 text-white"><?php echo $user['name']; ?></h4>
                            ...
                            <div class="col-sm-4">
                                <div class="card tilebox-one">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-muted text-uppercase mt-0">Paid Members</h6>
                                        <h2 class="m-b-20"><span><?php countpaid() ?></span></h2>
                                        <span class="badge bg-success"> <?php percentagestatus() ?></span> <span class="text-muted"></span>
                                    </div> <!-- end card-body-->
                                </div>
                                <!--end card-->
                            </div><!-- end col -->
                            ...
                            <div class="col-sm-4">
                                <div class="card tilebox-one">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-muted text-uppercase mt-0">Amount</h6>
                                        <h2 class="m-b-20"><?php echo totalstatus(); ?></h2>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="card tilebox-one">
                                    <div class="card-body">
                                        <i class="ri-shopping-basket-2-line float-end text-muted"></i>
                                        <h6 class="text-muted text-uppercase mt-0">Paid Certificated Counsellors</h6>
                                        <h2 class="m-b-20"><?php echo paidcertified() ?></h2>
                                        <span class="badge bg-primary"> <?php echo ppaidcertified() ?></span> <span class="text-muted"></span>
                                    </div> <!-- end card-body-->
                                </div>
                                <!--end card-->
                            </div><!-- end col -->
                            ...
                            <div class="col-sm-4">
                                <div class="card tilebox-one">
                                    <div class="card-body">
                                        <i class="ri-archive-line float-end text-muted"></i>
                                        <h6 class="text-muted text-uppercase mt-0">Paid Associate Counsellors</h6>
                                        <h2 class="m-b-20"><span><?php paidassociate() ?></span></h2>
                                        <span class="badge bg-success"> <?php ppaidassociate() ?></span> <span class="text-muted"></span>
                                    </div> <!-- end card-body-->
                                </div>
                                <!--end card-->
                            </div><!-- end col -->
                            ...
                            <div class="col-sm-4">
                                <div class="card tilebox-one">
                                    <div class="card-body">
                                        <i class="ri-vip-diamond-line float-end text-muted"></i>
                                        <h6 class="text-muted text-uppercase mt-0">Paid Student Counsellors</h6>
                                        <h2 class="m-b-20"><?php echo paidstudents(); ?></h2>
                                        <span class="badge bg-primary"><?php echo ppaidstudent(); ?></span> <span class="text-muted"></span>
                                    </div> <!-- end card-body-->
                                </div>
                                <!--end card-->
                            </div><!-- end col -->
                            ...
                            <div class="card-body pt-0">
                                <div class="border border-light p-3 rounded mb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <p class="font-18 mb-1">Certificated Counsellors</p>
                                            <h3 class="text-primary my-0"><?php echo certified();   echo pcertified(); ?></h3>
                                        </div>
                                        <div class="avatar-sm">
                                ...
                                <div class="border border-light p-3 rounded mb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <p class="font-18 mb-1">Associate Counsellors</p>
                                            <h3 class="text-danger my-0"><?php echo associate();   echo passociate();?></h3>
                                        </div>
                                ...
                                <div class="border border-light p-3 rounded">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <p class="font-18 mb-1">Student - Counsellors</p>
                                            <h3 class="text-success my-0"><?php echo students();   echo pstudents() ?></h3>
                                        </div>
                                        <div class="avatar-sm">
