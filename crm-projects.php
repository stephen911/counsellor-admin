...
<!-- Mirrored from coderthemes.com/hyper_2/modern/crm-projects.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:18:27 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Projects | GNACC -  </title>
    ...
    <body>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div id="monthly-target" class="apex-charts mb-4 mt-4" data-colors="#10c469,#727cf5"></div>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-6 order-1 order-md-2">
                                                <div class="mb-3 mb-md-0">
                                                    <div id="project-overview-chart" class="apex-charts" data-colors="#727cf5,#ff679b,#10c469,#ffbc00"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body py-0 mb-3" data-simplebar style="max-height: 304px;">
                                        <div class="border rounded p-2 mb-2">
                                            <ul class="list-inline mb-2">
                                                <li class="list-inline-item font-16 fw-semibold"><a href="javascript:void(0);" class="text-secondary">Landing Page Design</a></li>
                                        ...
                                        <div class="border rounded p-2 mb-2">
                                            <ul class="list-inline mb-2">
                                                <li class="list-inline-item font-16 fw-semibold"><a href="javascript:void(0);" class="text-secondary">Admin Dashboard</a></li>
                                                <li class="list-inline-item text-muted"><i class="mdi mdi-circle-small"></i></li>
                                        ...
                                        <div class="border rounded p-2 mb-2">
                                            <ul class="list-inline mb-2">
                                                <li class="list-inline-item font-16 fw-semibold"><a href="javascript:void(0);" class="text-secondary">Client Work</a></li>
                                                <li class="list-inline-item text-muted"><i class="mdi mdi-circle-small"></i></li>
                                        ...
                                        <div class="border rounded p-2 mb-2">
                                            <ul class="list-inline mb-2">
                                                <li class="list-inline-item font-16 fw-semibold"><a href="javascript:void(0);" class="text-secondary">UI/UX Design</a></li>
                                                <li class="list-inline-item text-muted"><i class="mdi mdi-circle-small"></i></li>
                                    ...
                                    <div class="card-body py-0 mb-3" data-simplebar style="max-height: 304px;">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="w-100 overflow-hidden">
                                                <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-secondary">Risa Pearson</a></h5>
                                        ...
                                        <div class="d-flex align-items-start mt-3">
                                            ...
                                            <div class="w-100 overflow-hidden">
                                                <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-secondary">Margaret D. Evans</a></h5>
                                                <ul class="list-inline mb-0 font-13">
                                        ...
                                        <div class="d-flex align-items-start mt-3">
                                            ...
                                            <div class="w-100 overflow-hidden">
                                                <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-secondary">Bryan J. Luellen</a></h5>
                                                <ul class="list-inline mb-0 font-13">
                                        ...
                                        <div class="d-flex align-items-start mt-3">
                                            ...
                                            <div class="w-100 overflow-hidden">
                                                <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-secondary">Kathryn S. Collier</a></h5>
                                                <ul class="list-inline mb-0 font-13">
                                                    <li class="list-inline-item">UI/UX Designer</li>
                                                    <li class="list-inline-item text-muted"><i class="mdi mdi-circle-small"></i></li>
                                        ...
                                        <div class="d-flex align-items-start mt-3">
                                            ...
                                            <div class="w-100 overflow-hidden">
                                                <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-secondary">Timothy Kauper</a></h5>
                                                <ul class="list-inline mb-0 font-13">
                                        ...
                                        <div class="d-flex align-items-start mt-3">
                                            ...
                                            <div class="w-100 overflow-hidden">
                                                <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-secondary">Zara Raws</a></h5>
                                                <ul class="list-inline mb-0 font-13">
        ...
        <script src="assets/js/pages/demo.crm-project.js"></script>
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/crm-projects.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:18:30 GMT -->
</html>
