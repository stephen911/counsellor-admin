...
<!-- Mirrored from coderthemes.com/hyper_2/modern/charts-apex-radialbar.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Nov 2022 09:19:48 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Apex RadialBar Charts | GNACC -  </title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="multiple-radialbar" class="apex-charts" data-colors="#6c757d,#ffbc00,#727cf5,#10c469"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center" dir="ltr">
                                            <div id="circle-angle-radial" class="apex-charts" data-colors="#10c469,#727cf5,#ff5b5b,#ffbc00"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
